...
public class ChildAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position)==SUB_CATEGORIES){
            WorDroidSectionItems category =  objectList.get(position);
        ...
        }else if (getItemViewType(position)== REC_CAROUSEL_POSTS_INNER_TITLE){
            WorDroidSectionItems post = (WorDroidSectionItems) objectList.get(position);
        ...
        }else if (getItemViewType(position)== REC_CAROUSEL_POSTS_OUTER_TITLE ){
            WorDroidSectionItems post = (WorDroidSectionItems) objectList.get(position);
        ...
        }else if (getItemViewType(position)==GRID_POST){
            WorDroidSectionItems post = (WorDroidSectionItems) objectList.get(position);
        ...
        }else if (getItemViewType(position)==LIST_POST){
            WorDroidSectionItems post = objectList.get(position);
