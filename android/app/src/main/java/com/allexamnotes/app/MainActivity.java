...
import com.allexamnotes.libdroid.model.settings.BottomNavigation;
import com.allexamnotes.libdroid.model.settings.ItemsItem;
import com.allexamnotes.libdroid.model.settings.NavDrawer;
...
//        MediationTestSuite.launch(MainActivity.this);
    ...
    private void setupFragments(){
        ...
        for(ItemsItem i : MainApplication.getAppSettings(getApplicationContext()).getSettings().getBottomNavigation().getItems()){
            if(i.getDestination()!=15||i.getDestination()!=14||i.getDestination()!=13||i.getDestination()!=12){
                adapter.addFragment(getDestinationFragment(i.getDestination(),i.getData()));
            }
        }
    ...
    private void handleIntent(Intent intent) {
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            i.putExtra("search",query);
            startActivity(i);
            PostListFragment.newInstance(null,null,null,query);
        }
    }
    ...
    private void inflateNavigationDrawerItems(){
        ...
        signInBtn.setOnClickListener(view -> {
            if (mAuth.getCurrentUser()==null) {
                ...
                mAuth.signOut();
                signInBtn.setText(R.string.login_btn_text);
            }
        });
        ...
        try {
            ...
            for (int i=0;i<drawerItems.size();i++){
                String color = drawerItems.get(i).getIconColor();
                ...
                menu.add(Menu.NONE, i + 10, Menu.NONE, drawerItems.get(i).getTitle())
                        .setIcon(new IconicsDrawable(this, "faw-"+drawerItems.get(i).getIcon())
                                .color(IconicsColor.parse(color)).actionBar());
            }
        }catch (Exception e){
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            }else if(menuItem.getDestination()==16){
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse(menuItem.getData())));
            }else{
    ...
    private void showUpdateDialog(){
        try {
            ...
            if (pInfo.versionCode < MainApplication.getAppSettings(getApplicationContext()).getUpdate().getVersion()) {
