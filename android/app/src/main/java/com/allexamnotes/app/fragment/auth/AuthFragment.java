package com.allexamnotes.app.fragment.auth;
...
import com.allexamnotes.libdroid.model.auth.AuthResponse;
import com.allexamnotes.libdroid.repo.AuthRepository;
    ...
    private void signupBtnClicked(){
        ...
        if (getContext() instanceof ContainerActivity){
            try {
                ...
                a.addFragment(new WebViewFragment().newInstance(getString(R.string.app_register_url)),"Register");
            }catch (Exception e){
                e.printStackTrace();
            }
